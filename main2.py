...
def myNetwork():
    ...
    h2suc2 = net.addHost('h2suc2',cls=Host, ip='10.0.2.2/24',defaultRoute='via 10.0.2.1')
    hsuc1 = net.addHost('hsuc1', cls=Host, ip='10.0.1.254/24', defaultRoute='via 10.0.1.1')
    h2suc1 = net.addHost('h2suc1',cls=Host,ip='10.0.1.2/24',defaultRoute='via 10.0.1.1')        
